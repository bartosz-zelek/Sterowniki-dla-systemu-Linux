...
class Test_concat_comma(unittest.TestCase):
...
class Test_type_options(unittest.TestCase):
...
class Test_type_encode(unittest.TestCase):
...
class Test_extract_indices(unittest.TestCase):
    def runTest(self):
        for (input, result) in [
                ('x', ('x', [])),
                ('x[3]', ('x[{}]', [3])),
...
class Test_is_cartesian_product(unittest.TestCase):
    def runTest(self):
        for bad in [
                # not zero-based
                [(1,)],
