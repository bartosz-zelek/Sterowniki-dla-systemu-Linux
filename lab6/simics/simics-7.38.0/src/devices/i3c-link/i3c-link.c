...
new_status_message(uint64 src_epid, i3c_link_action_type_t type,
                   uint8 status, const uint8 *data, uint8 len)
{
...
msg_from_attr(conf_object_t *link, attr_value_t attr)
{
        ...
        uint8 len = SIM_attr_data_size(payload);
                      ...
                      conf_object_t *device)
{
        ...
        if (ilep->pending_acks == 0) {
                if (ilep->address >> 1 == BROADCAST) {
                        ...
                        /* All slaves have responded the start call, return
...
link_ep_device_changed(conf_object_t *ep, conf_object_t *old_dev)
{
        ...
        if (old_dev == NULL) {
                ...
                SIMLINK_config_update_value(
                        SIMLINK_endpoint_link(ep), "", &value);
        }
}
...
static attr_value_t
get_int(void *user_data, conf_object_t *obj, attr_value_t *idx)
{
...
static set_error_t
set_int(void *user_data, conf_object_t *obj,
...
static attr_value_t
get_bool(void *user_data, conf_object_t *obj, attr_value_t *idx)
{
...
static set_error_t
set_bool(void *user_data, conf_object_t *obj,
         attr_value_t *val, attr_value_t *idx)
{
...
static attr_value_t
get_slave_list(void *user_data, conf_object_t *obj, attr_value_t *idx)
{
        i3c_link_endpoint_t *ilep = (i3c_link_endpoint_t *)obj;
...
static set_error_t
set_slave_list(void *user_data, conf_object_t *obj,
                            attr_value_t *val, attr_value_t *idx)
{
        i3c_link_endpoint_t *ilep = (i3c_link_endpoint_t *)obj;
...
static attr_value_t
get_slave_data_list(void *user_data, conf_object_t *obj, attr_value_t *idx)
{
        i3c_link_endpoint_t *ilep = (i3c_link_endpoint_t *)obj;
...
static set_error_t
set_slave_data_list(void *user_data, conf_object_t *obj,
                    attr_value_t *val, attr_value_t *idx)
{
        i3c_link_endpoint_t *ilep = (i3c_link_endpoint_t *)obj;
        size_t len = SIM_attr_list_size(*val);
...
init_i3c_link()
{
        ...
        SIM_register_typed_attribute(
                ...
                get_slave_data_list, NULL,
                set_slave_data_list, NULL,
                Sim_Attr_Optional, "[[ii]*]", NULL,
