...
public:
     ...
     *
     * @param bank_iface* pointer to the templated BankInterface
     ...
     */
    reg( simics::BankInterface *bank_iface, const simics::Name &name, simics::ByteSize byte_size,
         simics::InitValue init_val)
        : T(bank_iface, name, byte_size, init_val)
     ...
     */
    reg( simics::BankInterface *bank_iface, const simics::Name &name)
        : T(bank_iface, name)
        , m_live_transaction( false)
    {
    }
