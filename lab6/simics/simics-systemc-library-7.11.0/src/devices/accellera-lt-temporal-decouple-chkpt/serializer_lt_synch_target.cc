...
struct lt_synch_target::checkpoint_access {
    template <class Archive>
    static void serialize(Archive& ar,   // NOLINT(runtime/references)
                          lt_synch_target &module, const unsigned int version) {
...
void serialize(Archive& ar,   // NOLINT(runtime/references)
               lt_synch_target &module, const unsigned int version) {
    lt_synch_target::checkpoint_access::serialize(ar, module, version);
}

}  // namespace serialization
}  // namespace cci

static Serializer<lt_synch_target> lt_synch_target_serializer;
