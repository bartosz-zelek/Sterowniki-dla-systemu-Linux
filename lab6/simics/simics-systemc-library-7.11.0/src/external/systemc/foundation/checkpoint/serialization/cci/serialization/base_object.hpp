#ifndef CCI_SERIALIZATION_BASE_OBJECT_HPP
#define CCI_SERIALIZATION_BASE_OBJECT_HPP
...
namespace detail
{
    ...
    struct base_cast
    {
        ...
        boost::mpl::if_<
            ...
            B
        >::type type;
        BOOST_STATIC_ASSERT(boost::is_const<type>::value == boost::is_const<D>::value);
    };
...
base_object(Derived &d)
{
    ...
    BOOST_STATIC_ASSERT(! boost::is_pointer<Derived>::value);
...
#endif // CCI_SERIALIZATION_BASE_OBJECT_HPP
