...
int test_main(int /*argc*/, char* /*argv*/[])
{
    ...
    BOOST_REQUIRE(NULL != testfile);
    {
        ...
        cci::archive::polymorphic_oarchive & opa = oa_implementation;
        opa << CCI_SERIALIZATION_NVP(a);
    }
    A *loaded = 0;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia_implementation(is, TEST_ARCHIVE_FLAGS);
        cci::archive::polymorphic_iarchive & ipa = ia_implementation;
        ipa >> CCI_SERIALIZATION_NVP(loaded);
    }
