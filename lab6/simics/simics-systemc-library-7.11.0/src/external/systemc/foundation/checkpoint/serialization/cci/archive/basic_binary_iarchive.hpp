#ifndef CCI_ARCHIVE_BASIC_BINARY_IARCHIVE_HPP
#define CCI_ARCHIVE_BASIC_BINARY_IARCHIVE_HPP
...
protected:
    ...
    void load_override(tracking_type & t, int /*version*/){
        ...
        if(cci::archive::library_version_type(6) < lvt){
            int_least8_t x=0;
            * this->This() >> x;
            t = cci::archive::tracking_type(x);
        }
        else{
            bool x=0;
            * this->This() >> x;
    ...
    void load_override(class_id_type & t){
        library_version_type lvt = this->get_library_version();
        if(cci::archive::library_version_type(7) < lvt){
            this->detail_common_iarchive::load_override(t);
        }
        else
        if(cci::archive::library_version_type(6) < lvt){
    ...
    void load_override(version_type & t){
        ...
        if(cci::archive::library_version_type(6) < lvt){
            uint_least8_t x=0;
            * this->This() >> x;
            t = cci::archive::version_type(x);
        }
        else
        if(cci::archive::library_version_type(5) < lvt){
            uint_least16_t x=0;
            * this->This() >> x;
            t = cci::archive::version_type(x);
        }
        else
        if(cci::archive::library_version_type(2) < lvt){
            // upto 255 versions
            unsigned char x=0;
            * this->This() >> x;
            t = version_type(x);
    ...
    void load_override(cci::serialization::item_version_type & t){
        library_version_type lvt = this->get_library_version();
//        if(cci::archive::library_version_type(7) < lvt){
        if(cci::archive::library_version_type(6) < lvt){
            this->detail_common_iarchive::load_override(t);
        ...
        if(cci::archive::library_version_type(6) < lvt){
            uint_least16_t x=0;
            * this->This() >> x;
            t = cci::serialization::item_version_type(x);
        }
        else{
            unsigned int x=0;
            * this->This() >> x;
    ...
    void load_override(serialization::collection_size_type & t){
        if(cci::archive::library_version_type(5) < this->get_library_version()){
            this->detail_common_iarchive::load_override(t);
        }
        else{
            unsigned int x=0;
...
#endif // CCI_ARCHIVE_BASIC_BINARY_IARCHIVE_HPP
