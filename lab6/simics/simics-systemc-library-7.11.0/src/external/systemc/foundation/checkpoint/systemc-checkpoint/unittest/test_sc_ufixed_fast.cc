...
#include <systemc-checkpoint/serialization/sc_ufixed_fast.h>
...
BOOST_AUTO_TEST_SUITE(TestSerializerScUFixedFast)

SC_MODULE(TestModule) {
    SC_CTOR(TestModule) {}
    sc_dt::sc_ufixed_fast<1, 0> value_;
...
BOOST_FIXTURE_TEST_CASE(TestReverseUFixedFast,
...
BOOST_FIXTURE_TEST_CASE(TestRestoreUFixedFast,
                        unittest::SerializerEnvironment) {
    sc_checkpoint::serialization::Serializer<TestModule> serializer;
    TestModule module("TestModule");
    module.value_ = 0.5;
