#ifndef CCI_ARCHIVE_BINARY_WIARCHIVE_HPP
#define CCI_ARCHIVE_BINARY_WIARCHIVE_HPP
...
// required by export
CCI_SERIALIZATION_REGISTER_ARCHIVE(cci::archive::binary_wiarchive)

#endif // BOOST_NO_STD_WSTREAMBUF
#endif // CCI_ARCHIVE_BINARY_WIARCHIVE_HPP
