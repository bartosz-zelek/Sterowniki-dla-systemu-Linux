#ifndef CCI_SERIALIZATION_SINGLETON_HPP
#define CCI_SERIALIZATION_SINGLETON_HPP
...
{
private:
    CCI_SERIALIZATION_DECL BOOST_DLLEXPORT static bool & get_lock() BOOST_USED;
public:
...
#endif // CCI_SERIALIZATION_SINGLETON_HPP
