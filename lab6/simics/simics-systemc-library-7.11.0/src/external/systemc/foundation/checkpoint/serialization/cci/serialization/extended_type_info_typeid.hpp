#ifndef CCI_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
#define CCI_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
...
protected:
    ...
    CCI_SERIALIZATION_DECL extended_type_info_typeid_0(const char * key);
    CCI_SERIALIZATION_DECL ~extended_type_info_typeid_0();
    CCI_SERIALIZATION_DECL void type_register(const std::type_info & ti);
    CCI_SERIALIZATION_DECL void type_unregister();
...
public:
    ...
    const char * get_key() const {
        return cci::serialization::guid< T >();
    }
...
// before any of the other headers.
    ...
    struct extended_type_info_impl {
        typedef typename 
            cci::serialization::extended_type_info_typeid< T > type;
    };
    } // namespace serialization
    } // namespace cci
#endif
...
#endif // CCI_SERIALIZATION_EXTENDED_TYPE_INFO_TYPEID_HPP
