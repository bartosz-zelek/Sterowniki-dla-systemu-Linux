#ifndef CCI_SERIALIZATION_BASIC_OSERIALIZER_HPP
#define CCI_SERIALIZATION_BASIC_OSERIALIZER_HPP
...
protected:
    explicit CCI_ARCHIVE_DECL basic_oserializer(
        const cci::serialization::extended_type_info & type_
    );
    virtual CCI_ARCHIVE_DECL ~basic_oserializer();
public:
...
#endif // CCI_SERIALIZATION_BASIC_OSERIALIZER_HPP
