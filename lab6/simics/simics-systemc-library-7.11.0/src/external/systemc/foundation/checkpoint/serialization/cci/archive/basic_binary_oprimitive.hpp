#ifndef CCI_ARCHIVE_BASIC_BINARY_OPRIMITIVE_HPP
#define CCI_ARCHIVE_BASIC_BINARY_OPRIMITIVE_HPP
...
#include <cci/archive/basic_streambuf_locale_saver.hpp>
#include <cci/archive/codecvt_null.hpp>
...
public:
    ...
    cci::archive::codecvt_null<Elem> codecvt_null_facet;
...
public:
    ...
    struct use_array_optimization {
        template <class T>  
            ...
            struct apply {  
                typedef typename cci::serialization::is_bitwise_serializable< T >::type type;
            };
        #else
            struct apply : public cci::serialization::is_bitwise_serializable< T > {};
        #endif
    };

    // the optimized save_array dispatches to save_binary 
    template <class ValueType>
    void save_array(cci::serialization::array_wrapper<ValueType> const& a, unsigned int)
    {
...
#include <cci/archive/detail/abi_suffix.hpp> // pop pragmas

#endif // CCI_ARCHIVE_BASIC_BINARY_OPRIMITIVE_HPP
