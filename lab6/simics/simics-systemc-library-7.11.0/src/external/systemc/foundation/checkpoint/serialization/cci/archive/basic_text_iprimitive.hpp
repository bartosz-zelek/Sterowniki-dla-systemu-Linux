#ifndef CCI_ARCHIVE_BASIC_TEXT_IPRIMITIVE_HPP
#define CCI_ARCHIVE_BASIC_TEXT_IPRIMITIVE_HPP
...
protected:
    ...
    cci::archive::codecvt_null<typename IStream::char_type> codecvt_null_facet;
...
#endif // CCI_ARCHIVE_BASIC_TEXT_IPRIMITIVE_HPP
