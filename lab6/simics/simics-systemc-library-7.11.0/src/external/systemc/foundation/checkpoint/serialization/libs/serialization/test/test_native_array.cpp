...
int test_native_array(){
    ...
    const T b_array[2][3]={{T(),T(),T()},{T(),T(),T()}};
    {
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        {
            ...
            oa << cci::serialization::make_nvp("a_array", a_array);
            oa << cci::serialization::make_nvp("b_array", b_array);
        }
        os.close();
    }
    {
        ...
        test_istream is(testfile, TEST_STREAM_FLAGS);
        {
            ...
            ia >> cci::serialization::make_nvp("a_array", a_array1);
            ia >> cci::serialization::make_nvp("b_array", b_array1);
        }
        is.close();
