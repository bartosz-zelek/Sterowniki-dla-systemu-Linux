#ifndef CCI_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
#define CCI_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
...
#include <cci/archive/iterators/escape.hpp>
...
#endif // CCI_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
