#ifndef CCI_SERIALIZATION_ARRAY_WRAPPER_HPP
#define CCI_SERIALIZATION_ARRAY_WRAPPER_HPP
...
#include <cci/serialization/array_optimization.hpp>
...
private:
    ...
    friend const cci::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, boost::mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & cci::serialization::make_nvp("item", *t++);
    }
    ...
    {
      cci::serialization::split_member(ar, *this, version);
    }
...
#endif //CCI_SERIALIZATION_ARRAY_WRAPPER_HPP
