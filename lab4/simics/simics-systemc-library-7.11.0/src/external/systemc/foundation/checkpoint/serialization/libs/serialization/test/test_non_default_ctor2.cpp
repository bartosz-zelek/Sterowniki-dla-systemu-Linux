...
private:
    ...
    void serialize(ArchiveT& ar, const unsigned int /* file_version */)
    {
        ar & CCI_SERIALIZATION_NVP(floatValue);
    }
};
...
void save_construct_data(
    ...
    archive & cci::serialization::make_nvp("initialValue", p->value);
}
...
void load_construct_data(
    ...
    archive & cci::serialization::make_nvp("initialValue", initialValue);
...
int test_main( int /* argc */, char* /* argv */[] )
{
...

    {
        ...
        ia >> CCI_SERIALIZATION_NVP(a_new);
    }
    delete a;
    delete a_new;
    return EXIT_SUCCESS;
