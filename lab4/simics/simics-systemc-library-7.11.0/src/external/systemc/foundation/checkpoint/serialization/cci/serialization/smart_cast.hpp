#ifndef CCI_SERIALIZATION_SMART_CAST_HPP
#define CCI_SERIALIZATION_SMART_CAST_HPP
...
T smart_cast(U u) {
    typedef
        typename boost::mpl::eval_if<
            ...
            >,
            boost::mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename boost::mpl::eval_if<boost::is_pointer<U>,
            boost::mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename boost::mpl::eval_if<boost::is_reference<U>,
            boost::mpl::identity<smart_cast_impl::reference< T > >,
        // else
            boost::mpl::identity<smart_cast_impl::error< T >
        >
        >
        >
        >::type typex;
...
#endif // CCI_SERIALIZATION_SMART_CAST_HPP
