#ifndef CCI_SERIALIZATION_TRAITS_HPP
#define CCI_SERIALIZATION_TRAITS_HPP
...
template<
    ...
    class Wrapper = boost::mpl::false_
>
struct traits : public basic_traits {
    ...
    typedef typename boost::mpl::int_<Level> level;
    typedef typename boost::mpl::int_<Tracking> tracking;
    typedef typename boost::mpl::int_<Version> version;
...
#endif // CCI_SERIALIZATION_TRAITS_HPP
