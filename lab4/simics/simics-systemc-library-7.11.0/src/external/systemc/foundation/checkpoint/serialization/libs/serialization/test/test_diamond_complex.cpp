...
CCI_CLASS_TRACKING(EX1Level1, track_always)
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX1Level1);
    }
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX1Level2_A);
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX1Level2_B);
    }
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX1Level3_B);
    }
...
// but for now, this is not done so we have to rely on the programmer
// to specify this trait)
CCI_CLASS_TRACKING(EX2Level1, track_always)
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX2Level1);
    }
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX2Level2_A);
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX2Level2_B);
    }
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(EX2Level3_B);
    }
...
CCI_CLASS_EXPORT(EX1Level4)
CCI_CLASS_EXPORT(EX1Level3_A)

CCI_CLASS_EXPORT(EX2Level3_A)
CCI_CLASS_EXPORT(EX2Level4)
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    
	{
		...
		const EX1Level1 *ex1L1_save = &ex1L3a_save;
		{
			...
			oa << cci::serialization::make_nvp("ex1L1_save", ex1L1_save);
		}
		...
		EX1Level1 *ex1L1_load;
		{
			...
			ia >> cci::serialization::make_nvp("ex1L1_load", ex1L1_load);
		}
	...
	}
	{
		...
		const EX2Level1 *ex2L1_save = &ex2L3a_save;
		{
			test_ostream ofs(testfile, TEST_STREAM_FLAGS);
			test_oarchive oa(ofs);
			oa << cci::serialization::make_nvp("ex2L1_save", ex2L1_save);
		}
		...
		EX2Level1 *ex2L1_load;
		{
			test_istream ifs(testfile, TEST_STREAM_FLAGS);
			test_iarchive ia(ifs);
			ia >> cci::serialization::make_nvp("ex2L1_load", ex2L1_load);
		}
		BOOST_CHECK(1 == save_count);
		BOOST_CHECK(1 == load_count);
