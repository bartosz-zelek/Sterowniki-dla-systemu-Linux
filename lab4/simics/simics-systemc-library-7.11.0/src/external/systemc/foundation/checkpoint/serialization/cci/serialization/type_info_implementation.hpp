#ifndef CCI_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
#define CCI_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
...
#define CCI_CLASS_TYPE_INFO(T, ETI)              \
namespace cci {                                  \
namespace serialization {                          \
template<>                                         \
...
#endif /// CCI_SERIALIZATION_TYPE_INFO_IMPLEMENTATION_HPP
