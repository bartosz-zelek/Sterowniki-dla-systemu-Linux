...
#include <cci/serialization/priority_queue.hpp>
...
int test_main( int /* argc */, char* /* argv */[] )
{
    ...
    a_priority_queue.push(A());
    {
        ...
        oa << cci::serialization::make_nvp("a_priority_queue",a_priority_queue);
    }
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> cci::serialization::make_nvp("a_priority_queue",a_priority_queue1);
    }
