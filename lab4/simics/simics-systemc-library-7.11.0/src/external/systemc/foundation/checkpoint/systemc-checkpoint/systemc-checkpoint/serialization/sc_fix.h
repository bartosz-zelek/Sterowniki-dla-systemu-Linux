...
#ifndef SYSTEMC_CHECKPOINT_SERIALIZATION_SC_FIX_H
#define SYSTEMC_CHECKPOINT_SERIALIZATION_SC_FIX_H
...
inline void serialize(Archive &ar,   // NOLINT(runtime/references)
                      sc_dt::sc_fix &value,  // NOLINT(runtime/references)
...
void save(Archive &ar,   // NOLINT(runtime/references)
          const sc_dt::sc_fix &value, const unsigned int version) {
