...
#ifndef SYSTEMC_CHECKPOINT_SERIALIZATION_SC_UFIX_FAST_H
#define SYSTEMC_CHECKPOINT_SERIALIZATION_SC_UFIX_FAST_H
...
CCI_SERIALIZATION_SPLIT_FREE(sc_dt::sc_ufix_fast);
...
void load(Archive &ar,   // NOLINT(runtime/references)
          sc_dt::sc_ufix_fast &value,  // NOLINT
...
void save(Archive &ar,   // NOLINT(runtime/references)
          const sc_dt::sc_ufix_fast &value, const unsigned int version) {
