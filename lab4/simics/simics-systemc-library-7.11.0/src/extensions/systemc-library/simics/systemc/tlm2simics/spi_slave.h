...
#ifndef TLM2SIMICS_SPI_SLAVE_H
#define TLM2SIMICS_SPI_SLAVE_H
...
/** Protocol specific transaction handler for Simics
 * serial_peripheral_interface_slave interface.
 */
class SpiSlave : public InterfaceProvider,
                 public TransactionHandler {
  public:
    SpiSlave() : InterfaceProvider("serial_peripheral_interface_slave"),
