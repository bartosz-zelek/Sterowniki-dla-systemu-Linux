...
#ifndef DOCEA_PERF3_TYPES_H
#define DOCEA_PERF3_TYPES_H
...
typedef uint64 docea_perf3_status_t;
...
typedef struct {
  docea_perf3_status_t status;
} docea_perf3_status_result_t;
SIM_PY_ALLOCATABLE(docea_perf3_status_result_t);

// A representation of the physical simulation time. This is a number of
// picoseconds.
typedef uint64 docea_perf3_time_t;
