...
SIM_write_phys_memory(core, 0x4004, common.make_store(1, 2), 4)
...
run_command("nested_mem0.bp-break-memory 0x5678 4 -w")
run_command("bp.step.break %s 4" % cpu.name)
SIM_continue(0)
common.check_step(cpu, 2)
common.check_pc(cpu, 0x4008)
expect_equal(SIM_read_phys_memory(core, 0x5678, 4), 0x1234)
