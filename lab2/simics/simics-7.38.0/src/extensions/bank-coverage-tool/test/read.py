...
def test(_class):
    ...
    stest.expect_equal(len(connection.read_accesses), 2)
    stest.expect_true([0, 4, 1] in connection.read_accesses)
    stest.expect_true([4, 4, 1] in connection.read_accesses)
