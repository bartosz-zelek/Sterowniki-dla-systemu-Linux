...
from .state import GFXConnectionState, PCIEFunction, PCIESlotConnectionState, PCIEDevice
import os
...
def accel_vga(bp: Builder, name: Namespace,
              params: AccelVGAParams, gfx: GFXConnectionState, slot: PCIESlotConnectionState):
    import simics
    pci_bus = slot.bus
