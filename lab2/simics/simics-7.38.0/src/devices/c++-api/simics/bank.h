...
class Bank : public BankInterface,
  ...
  public:
    ...
    /* coverity[rule_of_five] copy ctor and assignment already deleted*/
    Bank(Bank &&rhs);
    /* coverity[rule_of_five] copy ctor and assignment already deleted*/
  ...
  private:
    ...
    bool has_range_overlap(uint64_t offset, uint64_t size) const;
    ...
    // @internal: Keeps track of allocated bank memory
