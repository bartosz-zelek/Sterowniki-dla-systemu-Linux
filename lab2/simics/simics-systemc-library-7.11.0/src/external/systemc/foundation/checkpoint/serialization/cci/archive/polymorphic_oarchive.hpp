#ifndef CCI_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
#define CCI_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
...
#include <cci/archive/detail/oserializer.hpp>
#include <cci/archive/detail/interface_oarchive.hpp>
...
// required by export
CCI_SERIALIZATION_REGISTER_ARCHIVE(cci::archive::polymorphic_oarchive)

#include <cci/archive/detail/abi_suffix.hpp> // pops abi_suffix.hpp pragmas

#endif // CCI_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
