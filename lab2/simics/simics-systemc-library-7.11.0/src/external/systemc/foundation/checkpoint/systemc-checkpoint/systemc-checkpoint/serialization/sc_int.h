...
#ifndef SYSTEMC_CHECKPOINT_SERIALIZATION_SC_INT_H
#define SYSTEMC_CHECKPOINT_SERIALIZATION_SC_INT_H
...
void save(Archive &ar,   // NOLINT(runtime/references)
          const sc_dt::sc_int<W> &value, const unsigned int version) {
    int64_t int_value = value.value();
    ar & SMD(int_value);
}
