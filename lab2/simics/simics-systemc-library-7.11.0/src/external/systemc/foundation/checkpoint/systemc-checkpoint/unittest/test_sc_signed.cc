...
#include <systemc-checkpoint/serialization/sc_signed.h>
...
BOOST_AUTO_TEST_SUITE(TestSerializerScSigned)
...
BOOST_FIXTURE_TEST_CASE(TestReverseSigned, unittest::SerializerEnvironment) {
...
BOOST_FIXTURE_TEST_CASE(TestRestoreSigned, unittest::SerializerEnvironment) {
    sc_checkpoint::serialization::Serializer<TestModule> serializer;
    TestModule module("TestModule");
    module.v1_ = -1;
    module.v2_ = -64;
