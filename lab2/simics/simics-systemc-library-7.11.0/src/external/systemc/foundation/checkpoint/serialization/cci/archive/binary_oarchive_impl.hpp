#ifndef CCI_ARCHIVE_BINARY_OARCHIVE_IMPL_HPP
#define CCI_ARCHIVE_BINARY_OARCHIVE_IMPL_HPP
...
#include <cci/archive/basic_binary_oprimitive.hpp>
#include <cci/archive/basic_binary_oarchive.hpp>
...
#endif // CCI_ARCHIVE_BINARY_OARCHIVE_IMPL_HPP
