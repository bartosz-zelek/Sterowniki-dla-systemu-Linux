...
#include <cci/archive/polymorphic_text_oarchive.hpp>
#include <cci/archive/polymorphic_text_iarchive.hpp>
...
test1(){
    ...
    {   
        ...
        cci::archive::text_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << cci::serialization::make_nvp("a", a);
    }
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        cci::archive::text_iarchive ia(is, TEST_ARCHIVE_FLAGS);
...
test2(){
    ...
    {   
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        cci::archive::polymorphic_text_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        cci::archive::polymorphic_oarchive & poa(oa);
        poa << cci::serialization::make_nvp("a", a);
    }
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        cci::archive::polymorphic_text_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        cci::archive::polymorphic_iarchive & pia(ia);
        pia >> cci::serialization::make_nvp("a", a1);
    }
    BOOST_CHECK_EQUAL(a, a1);
...
test5(){
    ...
    {   
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        cci::archive::text_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << cci::serialization::make_nvp("b", b);
    }
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        cci::archive::text_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> cci::serialization::make_nvp("b", b1);
    }
...
test6(){
    ...
    {   
        ...
        cci::archive::polymorphic_text_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        cci::archive::polymorphic_oarchive & poa(oa);
        poa << cci::serialization::make_nvp("b", b);
    }
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        cci::archive::polymorphic_text_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        cci::archive::polymorphic_iarchive & pia(ia);
        pia >> cci::serialization::make_nvp("b", b1);
    }
    BOOST_CHECK_EQUAL(b, b1);
