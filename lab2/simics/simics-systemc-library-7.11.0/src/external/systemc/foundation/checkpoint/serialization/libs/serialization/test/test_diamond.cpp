...
CCI_CLASS_TRACKING(base, track_always)
...
public:
    ...
    void save(Archive &ar, const unsigned int /* file_version */) const
    {
        ...
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(derived1);
        ar << CCI_SERIALIZATION_BASE_OBJECT_NVP(derived2);
    }
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    final b2;
    {
        ...
        ia >> cci::serialization::make_nvp("b2", b2);
    }
    ...
    testfile = cci::archive::tmpnam(NULL);
    BOOST_REQUIRE(NULL != testfile);
