...
#include <cci/archive/impl/basic_xml_grammar.hpp>
#include <cci/archive/xml_archive_exception.hpp>
...
struct append_string {
    ...
    #if 0
        typedef cci::archive::iterators::xml_unescape<Iterator> translator;
        contents.append(
            translator(CCI_MAKE_PFTO_WRAPPER(start)), 
            translator(CCI_MAKE_PFTO_WRAPPER(end))
        );
    #endif
