...
#include <cci/serialization/complex.hpp>
...
int test_main( int /* argc */, char* /* argv */[] )
{
    ...
    {   
        ...
        test_oarchive oa(os);
        oa << cci::serialization::make_nvp("afloatcomplex", a);
        oa << cci::serialization::make_nvp("adoublecomplex", b);
    }
    ...
    std::complex<double> b1;
    {
        ...
        test_iarchive ia(is);
        ia >> cci::serialization::make_nvp("afloatcomplex", a1);
        ia >> cci::serialization::make_nvp("adoublecomplex", b1);
    }
