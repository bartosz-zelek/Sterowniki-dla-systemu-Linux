#ifndef CCI_SERIALIZATION_WRAPPER_HPP
#define CCI_SERIALIZATION_WRAPPER_HPP
...
struct wrapper_traits : 
    public traits<T,Level,Tracking,Version,ETII,boost::mpl::true_> 
{};
...
#endif //CCI_SERIALIZATION_WRAPPER_HPP
