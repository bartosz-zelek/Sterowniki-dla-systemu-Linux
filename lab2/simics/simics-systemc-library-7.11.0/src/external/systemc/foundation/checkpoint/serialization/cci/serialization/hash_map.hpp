#ifndef  CCI_SERIALIZATION_HASH_MAP_HPP
#define CCI_SERIALIZATION_HASH_MAP_HPP
...
inline void load(
    ...
    cci::serialization::stl::load_hash_collection<
        ...
        BOOST_STD_EXTENSION_NAMESPACE::hash_map<
            Key, HashFcn, EqualKey, Allocator
        >,
        cci::serialization::stl::archive_input_hash_map<
            Archive, 
            BOOST_STD_EXTENSION_NAMESPACE::hash_map<
                Key, HashFcn, EqualKey, Allocator
            >
...
inline void load(
    ...
    cci::serialization::stl::load_hash_collection<
        ...
        BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
            Key, HashFcn, EqualKey, Allocator
        >,
        cci::serialization::stl::archive_input_hash_multimap<
            Archive, 
            BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
                Key, HashFcn, EqualKey, Allocator
            >
...
#endif // CCI_SERIALIZATION_HASH_MAP_HPP
