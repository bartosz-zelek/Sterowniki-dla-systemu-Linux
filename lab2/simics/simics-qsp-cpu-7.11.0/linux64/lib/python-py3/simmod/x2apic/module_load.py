...
new_info_command('x2apic', get_info)

def get_status(obj):
    ia32_apic_base = obj.apicbase_msr
    lvt_cmci = obj.lvt_cmci
...
new_status_command('x2apic', get_status)
...
new_info_command('x2apic-bus', get_apic_bus_info)

def get_apic_bus_status(obj):
    return []

new_status_command('x2apic-bus', get_apic_bus_status)
