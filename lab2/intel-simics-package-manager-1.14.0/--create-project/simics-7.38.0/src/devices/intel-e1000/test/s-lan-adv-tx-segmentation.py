...
def do_test(ipv4_ipv6, tcp_udp, enable_vlan, enable_delay, seg_size, payload_distribution):
    ...
    tb.adv_c_td_layout.word1.L4LEN = (8, 20)[tcp_udp == "tcp"]
    tb.adv_c_td_layout.word1.MSS = seg_size
    tb.adv_c_td_layout.word1.DTYP = 2
    tb.adv_c_td_layout.word1.DEXT = 1
    tb.adv_c_td_layout.word1.IPV4 = (0, 1)[ipv4_ipv6 == "ipv4"]
    tb.adv_c_td_layout.word1.L4T = (0, 1)[tcp_udp == "tcp"]

    tb.write_mem(next_td,
        tuple(tb.scratch_pad_mem.read(SCRATCH_C_TD_BASE, ICH9_LAN_C_TD_LEN)))
...
#    tb.write_value_le(addr_of("TIDV"), bits_of("TIDV"), tidv_val)
    ...
    tb.scratch_pad_mem.write(SCRATCH_D_TD_BASE,
