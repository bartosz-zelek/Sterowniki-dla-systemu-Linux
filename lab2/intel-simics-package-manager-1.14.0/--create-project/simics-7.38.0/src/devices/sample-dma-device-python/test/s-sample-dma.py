...
# with little modification to use Register_LE instead of Register_BE
...
dma_src_reg = du.Register_LE(mydma.bank.regs, 4, 4)
dma_dst_reg = du.Register_LE(mydma.bank.regs, 8, 4)
dma_ctrl_reg = du.Register_LE(mydma.bank.regs, 0, 4, du.Bitfield({'en': 31,
                                                                  'swt': 30,
                                                                  'eci': 29,
                                                                  'tc': 28,
                                                                  'sg': 27,
