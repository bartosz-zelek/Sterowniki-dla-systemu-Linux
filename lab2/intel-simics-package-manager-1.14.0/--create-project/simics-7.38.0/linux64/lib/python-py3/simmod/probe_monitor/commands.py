...
def html_report_cmd(obj, html_dir, probe_json_filename,
                    graph_spec_json_filename,  open_browser):
    mon = obj.object_data
    ...
    html = mon.create_html_report(html_dir, probe_json_filename,
                                  graph_spec_json_filename)

    blob = bytearray(html, encoding="utf-8")
    fd.write(blob)
    fd.close()
