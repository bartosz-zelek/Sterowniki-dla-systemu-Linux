...
BOOST_AUTO_TEST_SUITE(TestI2cMasterV2Extension_standalone)
  ...
  public:
    explicit TestModule(sc_core::sc_module_name = "TestModule") {
        ...
        dispatcher_.subscribe(
            sif::I2cMasterV2Extension::createReceiver(&master_));
    ...
    sif::I2cMasterV2Extension extension_;
...
BOOST_FIXTURE_TEST_CASE(testScMain, TestEnvironment) {
    ...
    producer.extension_.acknowledge(simics::types::I2C_ack);
