...
#ifndef SIMICS_SYSTEMC_INSTRUMENTATION_TOOL_CONTROLLER_PROCESS_ACTION_H
#define SIMICS_SYSTEMC_INSTRUMENTATION_TOOL_CONTROLLER_PROCESS_ACTION_H
...
/** \internal */
class ToolControllerProcessAction : public ToolController,
