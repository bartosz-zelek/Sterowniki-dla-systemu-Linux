...
struct td_initiator_top::checkpoint_access {
    template <class Archive>
    static void serialize(Archive& ar,   // NOLINT(runtime/references)
                          td_initiator_top &module,
...
void serialize(Archive& ar,   // NOLINT(runtime/references)
               td_initiator_top &module, const unsigned int version) {
    td_initiator_top::checkpoint_access::serialize(ar, module, version);
}

}  // namespace serialization
}  // namespace cci

static Serializer<td_initiator_top> td_initiator_top_serializer;
