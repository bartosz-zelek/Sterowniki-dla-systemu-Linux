#ifndef CCI_ARCHIVE_ITERATORS_XML_UNESCAPE_EXCEPTION_HPP
#define CCI_ARCHIVE_ITERATORS_XML_UNESCAPE_EXCEPTION_HPP
...
#endif //CCI_ARCHIVE_ITERATORS_XML_UNESCAPE_EXCEPTION_HPP
