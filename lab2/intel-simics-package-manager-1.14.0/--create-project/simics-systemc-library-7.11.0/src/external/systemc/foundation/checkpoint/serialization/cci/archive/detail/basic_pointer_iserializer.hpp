#ifndef CCI_ARCHIVE_BASIC_POINTER_ISERIALIZER_HPP
#define CCI_ARCHIVE_BASIC_POINTER_ISERIALIZER_HPP
...
protected:
    explicit CCI_ARCHIVE_DECL basic_pointer_iserializer(
        const cci::serialization::extended_type_info & type_
    );
    virtual CCI_ARCHIVE_DECL ~basic_pointer_iserializer();
public:
...
#endif // CCI_ARCHIVE_BASIC_POINTER_ISERIALIZER_HPP
