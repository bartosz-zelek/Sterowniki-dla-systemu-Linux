#ifndef CCI_SERIALIZATION_ITEM_VERSION_TYPE_HPP
#define CCI_SERIALIZATION_ITEM_VERSION_TYPE_HPP
...
CCI_IS_BITWISE_SERIALIZABLE(item_version_type)

CCI_CLASS_IMPLEMENTATION(item_version_type, primitive_type)

#endif //CCI_SERIALIZATION_ITEM_VERSION_TYPE_HPP
