...
#ifndef CCI_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_HPP
# define CCI_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_HPP

namespace cci { namespace archive { namespace detail {

// No instantiate_ptr_serialization overloads generated by
// CCI_SERIALIZATION_REGISTER_ARCHIVE that lexically follow the call
...
#define CCI_SERIALIZATION_REGISTER_ARCHIVE(Archive)                     \
namespace cci { namespace archive { namespace detail {                  \
...
// CCI_SERIALIZATION_REGISTER_ARCHIVE, below.
template <class Serializable>
...
#endif
}}} // namespace cci::archive::detail

#endif // CCI_ARCHIVE_DETAIL_INSTANTIATE_SERIALIZE_DWA2006521_HPP
