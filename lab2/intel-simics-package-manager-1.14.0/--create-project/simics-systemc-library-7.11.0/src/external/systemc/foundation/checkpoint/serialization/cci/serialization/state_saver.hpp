#ifndef CCI_SERIALIZATION_STATE_SAVER_HPP
#define CCI_SERIALIZATION_STATE_SAVER_HPP
...
public:
    ...
    ~state_saver() {
            ...
            typedef typename boost::mpl::eval_if<
                ...
                boost::mpl::identity<restore>,
                boost::mpl::identity<restore_with_exception>
            >::type typex;
...
#endif //CCI_SERIALIZATION_STATE_SAVER_HPP
