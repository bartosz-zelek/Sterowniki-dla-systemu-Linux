#ifndef  CCI_SERIALIZATION_UTILITY_HPP
#define CCI_SERIALIZATION_UTILITY_HPP
...
inline void serialize(
    ...
    ar & cci::serialization::make_nvp("first", const_cast<typef &>(p.first));
    ar & cci::serialization::make_nvp("second", p.second);
}

/// specialization of is_bitwise_serializable for pairs
template <class T, class U>
struct is_bitwise_serializable<std::pair<T,U> >
 : public boost::mpl::and_<is_bitwise_serializable< T >,is_bitwise_serializable<U> >
{
};
...
#endif // CCI_SERIALIZATION_UTILITY_HPP
