...
void save_derived(const char *testfile)
{
    ...
    oa << CCI_SERIALIZATION_NVP(rd1);
    oa << CCI_SERIALIZATION_NVP(rd2);
...
void load_derived(const char *testfile)
{
    ...
    ia >> CCI_SERIALIZATION_NVP(rd1);

    const cci::serialization::extended_type_info * p1;
    p1 = & cci::serialization::type_info_implementation<polymorphic_derived1>
        ::type::get_const_instance();

    BOOST_CHECK(NULL != p1);

    const cci::serialization::extended_type_info * p2;
    p2 = cci::serialization::type_info_implementation<polymorphic_derived1>
    ...
    p2 = cci::serialization::type_info_implementation<polymorphic_base>
...
void save_registered(const char *testfile)
{
    ...
    oa.register_type(static_cast<polymorphic_derived1 *>(NULL));
    oa.register_type(static_cast<polymorphic_derived2 *>(NULL));
    oa << CCI_SERIALIZATION_NVP(rb1) << CCI_SERIALIZATION_NVP(rb2);
...
void load_registered(const char *testfile)
{
    ...
    ia.register_type(static_cast<polymorphic_derived1 *>(NULL));
    ia.register_type(static_cast<polymorphic_derived2 *>(NULL));
    ia >> CCI_SERIALIZATION_NVP(rb1) >> CCI_SERIALIZATION_NVP(rb2);
