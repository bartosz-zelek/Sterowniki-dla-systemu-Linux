...
struct Base1 {
    ...
    void serialize(Archive & ar, const unsigned int /* file_version */) {
        ar & CCI_SERIALIZATION_NVP(m_x);
    }
};

//CCI_CLASS_EXPORT(Base1)
    ...
    public Base2 
{
    ...
    void serialize(Archive &ar, const unsigned int /* file_version */)
    {
        ar & CCI_SERIALIZATION_BASE_OBJECT_NVP(Base1);
        ar & CCI_SERIALIZATION_BASE_OBJECT_NVP(Base2);
        ar & CCI_SERIALIZATION_NVP(m_x);
    }
};

CCI_CLASS_EXPORT(Sub)
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    Base2 * pb2;
    {
        ...
        oa << cci::serialization::make_nvp("Base2", pb2);
    }
    Base2 * pb2_1;
    {
        // de-serialize
        ...
        ia >> cci::serialization::make_nvp("Base2", pb2_1);
    }
