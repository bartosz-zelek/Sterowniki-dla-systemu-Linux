...
void serialize(
    ...
    ar & cci::serialization::make_nvp("s", a.s);
    ar & cci::serialization::make_nvp("t", a.t);
    ar & cci::serialization::make_nvp("u", a.u);
    ar & cci::serialization::make_nvp("v", a.v);
    ar & cci::serialization::make_nvp("w", a.w);
    ar & cci::serialization::make_nvp("x", a.x);
}
