...
// #include <cci/serialization/scoped_ptr.hpp>
...
//    void serialize(Archive & ar, const unsigned int file_version);
    void serialize(cci::archive::polymorphic_oarchive & ar, const unsigned int file_version);
    void serialize(cci::archive::polymorphic_iarchive & ar, const unsigned int file_version);
    data();
    ~data();
