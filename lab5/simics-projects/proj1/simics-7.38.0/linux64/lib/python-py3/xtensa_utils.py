...
cli.new_command(
    ...
    doc = ("Print the local memory configuration for mapped"
           ...
           "The <arg>class</arg> argument specifies the specific"
           " Xtensa classname to list the internal memory regions from.")
    )
