...
class RegBankFunctionCall : public AfterCallInterface {
  public:
    ...
    RegBankFunctionCall(const RegBankFunctionCall &other)
        : func_(other.func_), name_(other.name_),
          obj_(other.obj_), dev_obj_(other.dev_obj_),
          hierarchical_object_name_(other.hierarchical_object_name_),
          args_(other.args_) {}
    RegBankFunctionCall& operator=(const RegBankFunctionCall& other) {
        if (this != &other) {
             // not a self-assignment
            func_ = other.func_;
            name_ = other.name_;
            obj_ = other.obj_;
            dev_obj_ = other.dev_obj_;
            hierarchical_object_name_ = other.hierarchical_object_name_;
            args_ = other.args_;
        }
        return *this;
