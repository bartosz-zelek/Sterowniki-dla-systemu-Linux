...
def tests(suite):
    ...
    suite.add_simics_tests('s-save-state-t1880000.py')
    suite.add_simics_tests('s-load-state-t1880000.py')
    suite.add_simics_tests('s-save-state-t4500000.py')
    suite.add_simics_tests('s-load-state-t4500000.py')
