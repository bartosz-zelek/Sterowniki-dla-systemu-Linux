...
all_logs = {}
dut = simics.SIM_create_object("lt_temporal_decouple_chkpt_example", 'dut', log_level=2)
...
stest.expect_true(any('=========================================================' in s for s in old_logs[4500000]))
stest.expect_true(any('      Traffic Generator : 101' in s for s in old_logs[4500000]))
