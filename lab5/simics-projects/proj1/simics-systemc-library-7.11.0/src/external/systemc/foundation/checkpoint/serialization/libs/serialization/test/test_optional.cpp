...
struct A {
    ...
    void serialize(Archive & ar, const unsigned int /* version */){
        ar & cci::serialization::make_nvp("x", m_x);
    };
...
int test_main( int /* argc */, char* /* argv */[] )
{
    ...
    const boost::optional<A *> aoptional6(& a);
    {
        ...
        oa << cci::serialization::make_nvp("aoptional3",aoptional3);
        oa << cci::serialization::make_nvp("aoptional4",aoptional4);
        oa << cci::serialization::make_nvp("aoptional5",aoptional5);
        oa << cci::serialization::make_nvp("aoptional6",aoptional6);
    }
    ...
    boost::optional<A *> aoptional6a;
    {
        ...
        ia >> cci::serialization::make_nvp("aoptional3",aoptional3a);
        ia >> cci::serialization::make_nvp("aoptional4",aoptional4a);
        ia >> cci::serialization::make_nvp("aoptional5",aoptional5a);
        ia >> cci::serialization::make_nvp("aoptional6",aoptional6a);
    }
