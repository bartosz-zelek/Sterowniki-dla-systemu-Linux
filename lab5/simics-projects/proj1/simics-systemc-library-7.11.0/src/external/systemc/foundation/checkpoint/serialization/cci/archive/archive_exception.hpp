#ifndef CCI_ARCHIVE_ARCHIVE_EXCEPTION_HPP
#define CCI_ARCHIVE_ARCHIVE_EXCEPTION_HPP
...
public:
    ...
    CCI_ARCHIVE_DECL archive_exception(
        exception_code c, 
        const char * e1 = NULL,
        const char * e2 = NULL
    ) BOOST_NOEXCEPT;
    CCI_ARCHIVE_DECL archive_exception(archive_exception const &) BOOST_NOEXCEPT ;
    virtual CCI_ARCHIVE_DECL ~archive_exception() BOOST_NOEXCEPT_OR_NOTHROW ;
    virtual CCI_ARCHIVE_DECL const char * what() const BOOST_NOEXCEPT_OR_NOTHROW ;
};
...
#endif //CCI_ARCHIVE_ARCHIVE_EXCEPTION_HPP
