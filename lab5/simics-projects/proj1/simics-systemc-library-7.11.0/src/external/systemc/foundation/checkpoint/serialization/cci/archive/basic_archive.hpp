#ifndef CCI_ARCHIVE_BASIC_ARCHIVE_HPP
#define CCI_ARCHIVE_BASIC_ARCHIVE_HPP
...
#define CCI_NULL_POINTER_TAG cci::archive::class_id_type(-1)
...
#define CCI_ARCHIVE_STRONG_TYPEDEF(T, D)         \
    class D : public T {                           \
    public:                                        \
...
CCI_ARCHIVE_STRONG_TYPEDEF(class_id_type, class_id_reference_type)
CCI_ARCHIVE_STRONG_TYPEDEF(class_id_type, class_id_optional_type)
CCI_ARCHIVE_STRONG_TYPEDEF(object_id_type, object_reference_type)
...
CCI_CLASS_IMPLEMENTATION(cci::archive::library_version_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::version_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::class_id_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::class_id_reference_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::class_id_optional_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::class_name_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::object_id_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::object_reference_type, primitive_type)
CCI_CLASS_IMPLEMENTATION(cci::archive::tracking_type, primitive_type)
...
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::library_version_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::version_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::class_id_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::class_id_reference_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::class_id_optional_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::class_name_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::object_id_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::object_reference_type)
CCI_IS_BITWISE_SERIALIZABLE(cci::archive::tracking_type)

#endif //CCI_ARCHIVE_BASIC_ARCHIVE_HPP
