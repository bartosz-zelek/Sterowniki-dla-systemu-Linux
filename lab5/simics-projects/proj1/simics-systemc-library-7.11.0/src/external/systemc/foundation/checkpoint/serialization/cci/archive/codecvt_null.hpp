#ifndef CCI_ARCHIVE_CODECVT_NULL_HPP
#define CCI_ARCHIVE_CODECVT_NULL_HPP
...
{
    virtual CCI_WARCHIVE_DECL BOOST_DLLEXPORT std::codecvt_base::result
    do_out(
        std::mbstate_t & state,
...
#endif //CCI_ARCHIVE_CODECVT_NULL_HPP
