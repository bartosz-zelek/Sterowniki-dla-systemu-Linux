#ifndef CCI_ARCHIVE_SERIALIZER_MAP_HPP
#define CCI_ARCHIVE_SERIALIZER_MAP_HPP
...
public:
    static CCI_ARCHIVE_OR_WARCHIVE_DECL bool insert(const basic_serializer * bs);
    static CCI_ARCHIVE_OR_WARCHIVE_DECL void erase(const basic_serializer * bs);
    static CCI_ARCHIVE_OR_WARCHIVE_DECL const basic_serializer * find(
...
#include <cci/archive/detail/abi_suffix.hpp> // must be the last header

#endif //CCI_ARCHIVE_SERIALIZER_MAP_HPP
