#ifndef CCI_ARCHIVE_BASIC_TEXT_OPRIMITIVE_HPP
#define CCI_ARCHIVE_BASIC_TEXT_OPRIMITIVE_HPP
...
protected:
    ...
    cci::archive::codecvt_null<typename OStream::char_type> codecvt_null_facet;
...
#endif // CCI_ARCHIVE_BASIC_TEXT_OPRIMITIVE_HPP
