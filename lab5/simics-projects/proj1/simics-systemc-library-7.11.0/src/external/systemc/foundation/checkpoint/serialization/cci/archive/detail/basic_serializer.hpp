#ifndef  CCI_ARCHIVE_BASIC_SERIALIZER_HPP
#define CCI_ARCHIVE_BASIC_SERIALIZER_HPP
...
{
    const cci::serialization::extended_type_info * m_eti;
protected:
...
public:
    ...
    const cci::serialization::extended_type_info & get_eti() const {
        return * m_eti;
    }
};
...
#endif // CCI_ARCHIVE_BASIC_SERIALIZER_HPP
