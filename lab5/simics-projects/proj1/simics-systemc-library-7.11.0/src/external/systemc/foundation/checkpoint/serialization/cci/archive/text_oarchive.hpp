#ifndef CCI_ARCHIVE_TEXT_OARCHIVE_HPP
#define CCI_ARCHIVE_TEXT_OARCHIVE_HPP
...
// required by export
CCI_SERIALIZATION_REGISTER_ARCHIVE(cci::archive::text_oarchive)
...
#endif // CCI_ARCHIVE_TEXT_OARCHIVE_HPP
