#ifndef  CCI_SERIALIZATION_DETAIL_STACK_CONSTRUCTOR_HPP
#define CCI_SERIALIZATION_DETAIL_STACK_CONSTRUCTOR_HPP
...
#endif //  CCI_SERIALIZATION_DETAIL_STACH_CONSTRUCTOR_HPP
