#ifndef CCI_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
#define CCI_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
...
#include <cci/archive/iterators/dataflow_exception.hpp>
    ...
    >
{
    ...
    cci::archive::detail::utf8_codecvt_facet m_codecvt_facet;
    std::mbstate_t m_mbs;
    ...
    sliding_buffer<typename boost::iterator_value<Base>::type> m_input;
    sliding_buffer<typename boost::iterator_value<this_t>::type> m_output;
...
void wchar_from_mb<Base>::drain(){
    ...
    for(;;){
        ...
        ++(this->base_reference());
        * const_cast<typename boost::iterator_value<Base>::type *>(
    ...
    typename boost::iterator_value<this_t>::type * next_available;
...
#endif // CCI_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
