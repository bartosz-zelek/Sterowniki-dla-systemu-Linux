...
#include <cci/serialization/list.hpp>
...
int test6()
{
  ...
  {
    cci::archive::text_oarchive oa(oss);
  ...
  cci::archive::text_iarchive ia(iss);
  ia>>b1;
...
void test8(){
    ...
    BOOST_CHECK_EQUAL(& b, b_ptr);
    {
        std::list<const B *> l;
        l.push_back(b_ptr);
        cci::archive::polymorphic_text_oarchive oa(ss);
    ...
    {
        std::list<B *> l;
        cci::archive::polymorphic_text_iarchive ia(ss);
