#ifndef CCI_ARCHIVE_POLYMORPHIC_TEXT_IARCHIVE_HPP
#define CCI_ARCHIVE_POLYMORPHIC_TEXT_IARCHIVE_HPP
...
CCI_SERIALIZATION_REGISTER_ARCHIVE(
    cci::archive::polymorphic_text_iarchive
)

#endif // CCI_ARCHIVE_POLYMORPHIC_TEXT_IARCHIVE_HPP
