...
BOOST_AUTO_TEST_SUITE(TestSerializerScUnSigned)

SC_MODULE(TestModule) {
    SC_CTOR(TestModule) : v1_(1), v2_(7), v3_(8), v4_(9) {}
    sc_dt::sc_unsigned v1_;
    sc_dt::sc_unsigned v2_;
    sc_dt::sc_unsigned v3_;
    sc_dt::sc_unsigned v4_;
...
BOOST_FIXTURE_TEST_CASE(TestReverseUnSigned, unittest::SerializerEnvironment) {
...
BOOST_FIXTURE_TEST_CASE(TestRestoreUnSigned, unittest::SerializerEnvironment) {
    sc_checkpoint::serialization::Serializer<TestModule> serializer;
    TestModule module("TestModule");
    module.v1_ = 1;
    module.v2_ = 64;
