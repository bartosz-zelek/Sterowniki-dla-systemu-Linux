...
#ifndef SYSTEMC_CHECKPOINT_SERIALIZATION_SC_SIGNAL_RV_H
#define SYSTEMC_CHECKPOINT_SERIALIZATION_SC_SIGNAL_RV_H
...
inline void serialize(Archive &ar,   // NOLINT(runtime/references)
                      sc_core::sc_signal_rv<W> &rv,  // NOLINT
                      const unsigned int file_version) {
    split_free(ar, rv, file_version);
}
...
void load(Archive &ar,   // NOLINT(runtime/references)
    ...
    std::vector<sc_dt::sc_lv<W> *> val_vec;
    std::vector<sc_core::sc_process_b *> proc_vec;
    std::vector<std::string> processes;

    sc_core::sc_signal<sc_dt::sc_lv<W>, sc_core::SC_MANY_WRITERS> &base =
        static_cast<sc_core::sc_signal<sc_dt::sc_lv<W>,
                                       sc_core::SC_MANY_WRITERS> &> (rv);
    ...
    sc_core::simContextProxyCheckpoint::set_sc_signal_rv_val_vec(&rv, val_vec);
...
void save(Archive &ar,   // NOLINT(runtime/references)
          const sc_core::sc_signal_rv<W> &rv, const unsigned int version) {
    std::vector<sc_dt::sc_lv<W> *> val_vec =
        sc_core::simContextProxyCheckpoint::sc_signal_rv_val_vec(&rv);
    std::vector<sc_core::sc_process_b *> proc_vec =
        sc_core::simContextProxyCheckpoint::sc_signal_resolved_proc_vec(&rv);
    ...
    const sc_core::sc_signal<sc_dt::sc_lv<W>, sc_core::SC_MANY_WRITERS> &base =
        static_cast<const sc_core::sc_signal<sc_dt::sc_lv<W>,
