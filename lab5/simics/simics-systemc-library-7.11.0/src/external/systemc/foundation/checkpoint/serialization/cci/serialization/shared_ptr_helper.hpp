#ifndef CCI_SERIALIZATION_SHARED_PTR_HELPER_HPP
#define CCI_SERIALIZATION_SHARED_PTR_HELPER_HPP
...
public:
    ...
    friend void cci::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    std::list<cci_132::shared_ptr<const void> > * m_pointers_132;
    void
    append(const cci_132::shared_ptr<const void> & t){
        if(NULL == m_pointers_132)
            m_pointers_132 = new std::list<cci_132::shared_ptr<const void> >;
    ...
    struct non_polymorphic {
        template<class U>
        static const cci::serialization::extended_type_info *
        get_object_type(U & ){
            return & cci::serialization::singleton<
                typename 
                cci::serialization::type_info_implementation< U >::type
            >::get_const_instance();
        }
    };
    struct polymorphic {
...
public:
    ...
    void reset(SPT< T > & s, T * t){
        ...
        const cci::serialization::extended_type_info * this_type
        ...
        if(NULL == true_type)
            cci::serialization::throw_exception(
                cci::archive::archive_exception(
                    cci::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            cci::serialization::throw_exception(
                cci::archive::archive_exception(
                    cci::archive::archive_exception::unregistered_cast,
...
#endif // CCI_SERIALIZATION_SHARED_PTR_HELPER_HPP
