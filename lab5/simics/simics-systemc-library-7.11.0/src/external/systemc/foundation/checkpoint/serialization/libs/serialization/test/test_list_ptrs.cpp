...
void test_list(){
    ...
    {   
        ...
        oa << cci::serialization::make_nvp("alist", alist);
        oa << cci::serialization::make_nvp("free_a_ptr", free_a_ptr);
    }
    std::list<A *> alist1;
    {
        ...
        A * free_a_ptr1;
        ia >> cci::serialization::make_nvp("alist", alist1);
        ia >> cci::serialization::make_nvp("free_a_ptr", free_a_ptr1);
        BOOST_CHECK(
