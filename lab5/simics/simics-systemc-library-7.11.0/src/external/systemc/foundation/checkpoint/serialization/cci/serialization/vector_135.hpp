...
#ifndef  CCI_SERIALIZATION_VECTOR_135_HPP
#define CCI_SERIALIZATION_VECTOR_135_HPP

#ifdef CCI_SERIALIZATION_VECTOR_VERSIONED
#if BOOST_SERIALIZATION_VECTOR_VERSION != 4
#error "Boost.Serialization cannot be compatible with both 1.35 and 1.36-1.40 files"
#endif
#else
#define CCI_SERIALIZATION_VECTOR_VERSIONED(V) (V>4)
#endif

#include <cci/serialization/vector.hpp>

#endif // CCI_SERIALIZATION_VECTOR_135_HPP
