...
#include <systemc-checkpoint/serialization/sc_bigint.h>
...
BOOST_AUTO_TEST_SUITE(TestSerializerScBigInt)

SC_MODULE(TestModule) {
    SC_CTOR(TestModule) {}
    sc_dt::sc_bigint<1> v1_;
    sc_dt::sc_bigint<7> v2_;
    sc_dt::sc_bigint<8> v3_;
    sc_dt::sc_bigint<9> v4_;
...
BOOST_FIXTURE_TEST_CASE(TestReverseBigInt, unittest::SerializerEnvironment) {
...
BOOST_FIXTURE_TEST_CASE(TestRestoreBigInt, unittest::SerializerEnvironment) {
    sc_checkpoint::serialization::Serializer<TestModule> serializer;
    TestModule module("TestModule");
    module.v1_ = -1;
    module.v2_ = -64;
