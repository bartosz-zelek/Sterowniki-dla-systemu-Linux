...
#ifndef SYSTEMC_CHECKPOINT_SERIALIZATION_SC_UFIX_H
#define SYSTEMC_CHECKPOINT_SERIALIZATION_SC_UFIX_H
...
void save(Archive &ar,   // NOLINT(runtime/references)
          const sc_dt::sc_ufix &value, const unsigned int version) {
