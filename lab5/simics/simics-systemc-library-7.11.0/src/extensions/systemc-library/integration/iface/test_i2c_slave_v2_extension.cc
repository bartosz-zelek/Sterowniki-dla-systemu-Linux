...
BOOST_AUTO_TEST_SUITE(TestI2cSlaveV2Extension_standalone)
  ...
  public:
    explicit TestModule(sc_core::sc_module_name = "TestModule") {
        ...
        dispatcher_.subscribe(
            sif::I2cSlaveV2Extension::createReceiver(&slave_));
    ...
    sif::I2cSlaveV2Extension extension_;

    // receiver and interface implementation
    MockI2cSlaveV2 slave_;
