...
#ifndef SIMICS_SYSTEMC_SC_SIGNAL_ACCESS_REGISTRY_H
#define SIMICS_SYSTEMC_SC_SIGNAL_ACCESS_REGISTRY_H
...
class ScSignalAccessRegistry : public ScSignalAccessInterface {
  public:
