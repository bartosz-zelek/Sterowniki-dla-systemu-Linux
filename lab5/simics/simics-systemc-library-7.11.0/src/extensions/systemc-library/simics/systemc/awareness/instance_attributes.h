...
#ifndef SIMICS_SYSTEMC_AWARENESS_INSTANCE_ATTRIBUTES_H
#define SIMICS_SYSTEMC_AWARENESS_INSTANCE_ATTRIBUTES_H
...
class InstanceAttributes : public InstanceAttributesInterface {
  public:
