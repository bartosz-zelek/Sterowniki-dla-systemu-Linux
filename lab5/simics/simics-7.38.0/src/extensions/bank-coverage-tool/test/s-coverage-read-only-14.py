...
(dev_name, banks, dev) = common.create_test_device('test_bank_coverage_14')
...
def expect_full_coverage(read = False, write = False):
    ...
    expect_equal(read_coverage, 1.0)

expect_full_coverage(read = True, write = True)
expect_full_coverage(read = True)

read_write.write(0)

expect_full_coverage(write = True)
