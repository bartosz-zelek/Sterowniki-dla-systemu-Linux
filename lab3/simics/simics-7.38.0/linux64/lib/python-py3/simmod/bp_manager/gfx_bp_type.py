...
common_doc = """
A graphical breakpoint matches when its image appears on the
screen, in the same location as when it was saved. The breakpoint must
have been created using the Simics GUI or the command <cmd
class="graphcon">save-break-xy</cmd>. The screen is checked for
matches every <arg>interval</arg> seconds of virtual time on the clock
associated to the console.
"""
