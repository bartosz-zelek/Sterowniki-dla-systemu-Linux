#ifndef  CCI_SERIALIZATION_PRIORITY_QUEUE_HPP
#define CCI_SERIALIZATION_PRIORITY_QUEUE_HPP
...
CCI_SERIALIZATION_COLLECTION_TRAITS(STD::priority_queue)

#undef STD

#endif // CCI_SERIALIZATION_PRIORITY_QUEUE_HPP
