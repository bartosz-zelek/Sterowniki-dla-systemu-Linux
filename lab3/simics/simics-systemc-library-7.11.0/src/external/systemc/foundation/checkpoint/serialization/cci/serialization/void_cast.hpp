#ifndef  CCI_SERIALIZATION_VOID_CAST_HPP
#define CCI_SERIALIZATION_VOID_CAST_HPP
...
#include <cci/serialization/void_cast_fwd.hpp>
...
CCI_SERIALIZATION_DECL void const *
void_upcast(
    ...
    private boost::noncopyable
{
    ...
    friend 
    CCI_SERIALIZATION_DECL void const *
    cci::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
protected:
    CCI_SERIALIZATION_DECL void recursive_register(bool includes_virtual_base = false) const;
    CCI_SERIALIZATION_DECL void recursive_unregister() const;
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            cci::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            cci::serialization::smart_cast<const Base *, const Derived *>(
...
#endif // CCI_SERIALIZATION_VOID_CAST_HPP
