#ifndef CCI_SERIALIZATION_SERIALIZATION_HPP
#define CCI_SERIALIZATION_SERIALIZATION_HPP
...
// by specifying friend class cci::serialization::access
...
CCI_STRONG_TYPEDEF(unsigned int, version_type)
...
// i.e. cci::serialization will be searched.
// 
...
#endif //CCI_SERIALIZATION_SERIALIZATION_HPP
