#ifndef CCI_SERIALIZATION_NVP_HPP
#define CCI_SERIALIZATION_NVP_HPP
...
#define CCI_SERIALIZATION_NVP(name)                              \
    cci::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define CCI_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    cci::serialization::make_nvp(                                \
        BOOST_PP_STRINGIZE(name),                                  \
        cci::serialization::base_object<name >(*this)            \
    )
/**/

#endif // CCI_SERIALIZATION_NVP_HPP
