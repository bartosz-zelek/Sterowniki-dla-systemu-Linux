#ifndef CCI_SERIALIZATION_STATIC_WARNING_HPP
#define CCI_SERIALIZATION_STATIC_WARNING_HPP
...
// Enable the warnings relied on by CCI_STATIC_WARNING, where possible.
...
#define CCI_SERIALIZATION_BSW(B, L) \
    typedef cci::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( cci::serialization::static_warning_test< B, L > ) \
    > BOOST_JOIN(STATIC_WARNING_LINE, L) BOOST_ATTRIBUTE_UNUSED; 
#define CCI_STATIC_WARNING(B) CCI_SERIALIZATION_BSW(B, __LINE__)

#endif // CCI_SERIALIZATION_STATIC_WARNING_HPP
