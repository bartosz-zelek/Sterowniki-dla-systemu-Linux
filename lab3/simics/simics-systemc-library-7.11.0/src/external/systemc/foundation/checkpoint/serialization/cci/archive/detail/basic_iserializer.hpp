#ifndef CCI_ARCHIVE_DETAIL_BASIC_ISERIALIZER_HPP
#define CCI_ARCHIVE_DETAIL_BASIC_ISERIALIZER_HPP
...
protected:
    explicit CCI_ARCHIVE_DECL basic_iserializer(
        const cci::serialization::extended_type_info & type
    );
    virtual CCI_ARCHIVE_DECL ~basic_iserializer();
public:
...
#endif // CCI_ARCHIVE_DETAIL_BASIC_ISERIALIZER_HPP
