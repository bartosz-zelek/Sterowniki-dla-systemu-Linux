#ifndef  CCI_SERIALIZER_MAP_HPP
#define CCI_SERIALIZER_MAP_HPP
    ...
    boost::noncopyable
{
    ...
    map_type m_map;
public:
    CCI_ARCHIVE_DECL bool insert(const basic_serializer * bs);
    CCI_ARCHIVE_DECL void erase(const basic_serializer * bs);
    CCI_ARCHIVE_DECL const basic_serializer * find(
