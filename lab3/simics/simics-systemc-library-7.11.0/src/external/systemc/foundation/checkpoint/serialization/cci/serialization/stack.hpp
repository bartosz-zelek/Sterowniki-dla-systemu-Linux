#ifndef  CCI_SERIALIZATION_STACK_HPP
#define CCI_SERIALIZATION_STACK_HPP
...
inline void serialize(
    ...
    typedef typename boost::mpl::eval_if<
        ...
        boost::mpl::identity<detail::stack_save<T, C> >,
        boost::mpl::identity<detail::stack_load<T, C> >
    >::type typex;
...
CCI_SERIALIZATION_COLLECTION_TRAITS(STD::stack)
