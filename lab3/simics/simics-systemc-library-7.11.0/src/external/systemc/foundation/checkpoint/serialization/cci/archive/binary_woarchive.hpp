#ifndef CCI_ARCHIVE_BINARY_WOARCHIVE_HPP
#define CCI_ARCHIVE_BINARY_WOARCHIVE_HPP
...
// required by export
CCI_SERIALIZATION_REGISTER_ARCHIVE(cci::archive::binary_woarchive)

#endif // BOOST_NO_STD_WSTREAMBUF
#endif // CCI_ARCHIVE_BINARY_WOARCHIVE_HPP
