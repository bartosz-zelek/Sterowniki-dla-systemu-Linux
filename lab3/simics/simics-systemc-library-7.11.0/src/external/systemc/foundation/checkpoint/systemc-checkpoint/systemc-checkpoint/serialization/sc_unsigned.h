...
#ifndef SYSTEMC_CHECKPOINT_SERIALIZATION_SC_UNSIGNED_H
#define SYSTEMC_CHECKPOINT_SERIALIZATION_SC_UNSIGNED_H
...
inline void serialize(Archive &ar,   // NOLINT(runtime/references)
                      sc_dt::sc_unsigned &value,  // NOLINT
...
void save(Archive &ar,   // NOLINT(runtime/references)
          const sc_dt::sc_unsigned &value, const unsigned int version) {
