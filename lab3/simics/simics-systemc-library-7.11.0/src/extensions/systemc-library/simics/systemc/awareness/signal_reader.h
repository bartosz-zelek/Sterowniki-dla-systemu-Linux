...
#ifndef SIMICS_SYSTEMC_AWARENESS_SIGNAL_READER_H
#define SIMICS_SYSTEMC_AWARENESS_SIGNAL_READER_H
...
// \internal
class SignalReader : public iface::ScSignalReadInterface {
  public:
    explicit SignalReader(ProxyInterface *proxy);
    virtual ~SignalReader();
    virtual attr_value_t read();
  private:
